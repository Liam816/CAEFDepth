...
def error(message: str, file_name="", func_name="") -> None:
    suffix = " | FILE:{} | FUNC:{}".format(file_name, func_name)
...
def get_file_func_name():
    return __file__.split('/')[-1], sys._getframe().f_code.co_name


def log(message: str, file_name="", func_name="", end="\n") -> None:
    # suffix = " | FILE:{} | FUNC:{}".format(file_name, func_name)
    # message = message + suffix
    time_stamp = get_curr_time_stamp()
    log_str = (
