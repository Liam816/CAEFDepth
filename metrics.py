...
class Result(object):
    ...
    def update(self, irmse, imae, mse, rmse, rmse_log, mae, absrel, lg10, delta1, delta2, delta3, gpu_time, data_time, silog, sq_rel):
    ...
    def evaluate(self, output, target):
        ...
        err = torch.log(output) - torch.log(target)
        self.silog = torch.sqrt(torch.mean(err ** 2) - torch.mean(err) ** 2) * 100
        self.sq_rel = torch.mean(((target - output) ** 2) / target)
...
class AverageMeter(object):
    ...
    def update(self, result, gpu_time, data_time, n=1):
        ...
        self.sum_sq_rel += n * result.sq_rel
    ...
    def average(self):
        ...
        avg.update(
            ...
            self.sum_silog / self.count, self.sum_sq_rel / self.count
        )
        return avg
