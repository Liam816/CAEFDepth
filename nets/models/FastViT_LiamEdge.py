...
from nets.modules.mobileone import MobileOneBlock
from nets.modules.replknet import ReparamLargeKernelConv
...
class FastViTEdge(nn.Module):
    def __init__(self, opts):
        super(FastViTEdge, self).__init__()
        mode = getattr(opts, 'model.mode', 's12')
        if mode == 's12':
            self.rgb_feature_extractor = fastvit_s12()
