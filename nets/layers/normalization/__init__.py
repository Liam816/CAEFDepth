...
def arguments_norm_layers(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--model.normalization.groups", default=1, type=str,
    ...
    group.add_argument("--model.normalization.adjust-bn-momentum.enable", action="store_true",
                       help="Adjust momentum in batch normalization layers")
    group.add_argument("--model.normalization.adjust-bn-momentum.anneal-type", default="cosine", type=str,
                       help="Method for annealing momentum in Batch normalization layer")
    group.add_argument("--model.normalization.adjust-bn-momentum.final-momentum-value", default=1e-6, type=float,
...
for file in os.listdir(norm_dir):
    ...
    if (
        ...
        module = importlib.import_module("nets.layers.normalization." + model_name)
